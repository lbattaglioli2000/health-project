...
<form class="form-signin" method="post" action="{{ route('login') }}">
    ...
    <div class="text-center mb-4">
        ...
        <p>Please sign in with an existing ReachOut account. Please register, if you do not have one.</p>
    </div>
    ...
    <button class="btn btn-lg btn-primary btn-block" type="submit">Sign in and ReachOut</button>
    <hr>
